package io.quarkus.ts.security.keycloak.oidcclient.extended.resources;
...
public class OidcWiremockTestResource {
    ...
    public void start(boolean debug) {
        ...
        server = new WireMockServer(
                wireMockConfig()
                        ...
                        .dynamicPort());
        if (debug) {
            server.addMockServiceRequestListener(OidcWiremockTestResource::requestReceived);
        }
    ...
    protected static void requestReceived(Request inRequest, com.github.tomakehurst.wiremock.http.Response inResponse) {
        ...
        LOG.info("WireMock request headers: " + inRequest.getHeaders());
        LOG.info("WireMock response body: " + inResponse.getBodyAsString());
        LOG.info("WireMock response headers: " + inResponse.getHeaders());
    }
